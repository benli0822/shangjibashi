...
public class CommandServiceImpl implements CommandService {
  ...
  public boolean addDishToCommand(long dish_id, long command_id, int quantity) {
    ...
    logger.debug("Dish " + theDish.toString() + " Command " + theCommand.toString() + " with quantity: " +
        quantity);
  ...
  public boolean addActivityToCommand(long activity_id, long command_id, int quantity) {
    ...
    logger.debug("Activity " + theActivity.toString() + " Command " + theCommand.toString() + " with quantity: "
        + quantity);
  ...
  public boolean addMenuToCommand(long menu_id, long command_id, int quantity) {
    ...
    logger.debug("Menu " + theMenu.toString() + " Command " + theCommand.toString() + " with quantity: " +
        quantity);
